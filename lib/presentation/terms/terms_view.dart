  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: TitleBar(title: 'Terms and Conditions'),
      ),
      body: SafeArea(
        child: Padding(
          ...
          child: ListView(
            children: [
              Text(
                ...
                style: titleLargeStyle(context).copyWith(color: kWhite),
              ),
              const Gap(kGap),
              Text(
              ...
              Text('2. Free Trial', style: titleMediumStyle(context)),
              const Gap(kGap),
              Text(
              ...
              Text('5. User Agreement', style: titleMediumStyle(context)),
              const Gap(kGap),
              Text(
